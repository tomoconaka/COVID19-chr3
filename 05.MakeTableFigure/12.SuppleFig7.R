...
tmp <- all %>% filter(Outcome == "resp_severe")
tmp <- tmp[c(1,6,3,8,4,7,2,5),]
colnames(tmp)[c(5,13)] <- c("N cases", "Study")
m1 <- metagen(beta,
              se,
              data=tmp,
              ...
              prediction=FALSE,
              sm="MD")
png("plots/SuppleFig7_4.png", width=700, height=300)
forest(m1, smlab="",xlim=c(-5,5),leftcols=c("studlab", "N cases"),
       rightcols=c("effect", "ci"),print.I2.ci = TRUE,print.tau2 = FALSE,
       leftlabs = c("Ancestry", "N cases"),rightlabs = c("Coefficients","95%CI"),zero.pval = TRUE)
dev.off()

tmp <- all %>% filter(Outcome == "hepatic")
colnames(tmp)[c(5,13)] <- c("N cases", "Study")
m1 <- metagen(beta,
              se,
              data=tmp,
              ...
              prediction=FALSE,
              sm="MD")
png("plots/SuppleFig7_5.png", width=700, height=300)
forest(m1, smlab="",xlim=c(-5,5),leftcols=c("studlab", "N cases"),
       rightcols=c("effect", "ci"),print.I2.ci = TRUE,print.tau2 = FALSE,
       leftlabs = c("Ancestry", "N cases"),rightlabs = c("Coefficients","95%CI"),zero.pval = TRUE)
dev.off()

tmp <- all %>% filter(Outcome == "cardiac")
colnames(tmp)[c(5,13)] <- c("N cases", "Study")
m1 <- metagen(beta,
              se,
              data=tmp,
              ...
              prediction=FALSE,
              sm="MD")
png("plots/SuppleFig7_6.png", width=700, height=300)
forest(m1, smlab="",xlim=c(-5,5),leftcols=c("studlab", "N cases"),
       rightcols=c("effect", "ci"),print.I2.ci = TRUE,print.tau2 = FALSE,
       leftlabs = c("Ancestry", "N cases"),rightlabs = c("Coefficients","95%CI"),zero.pval = TRUE)
dev.off()

tmp <- all %>% filter(Outcome == "aki")
colnames(tmp)[c(5,13)] <- c("N cases", "Study")
m1 <- metagen(beta,
              se,
              data=tmp,
              ...
              prediction=FALSE,
              sm="MD")
png("plots/SuppleFig7_7.png", width=700, height=300)
forest(m1, smlab="",xlim=c(-5,5),leftcols=c("studlab", "N cases"),
       rightcols=c("effect", "ci"),print.I2.ci = TRUE,print.tau2 = FALSE,
       leftlabs = c("Ancestry", "N cases"),rightlabs = c("Coefficients","95%CI"),zero.pval = TRUE)
dev.off()

tmp <- all %>% filter(Outcome == "vte")
colnames(tmp)[c(5,13)] <- c("N cases", "Study")
m1 <- metagen(beta,
              se,
              data=tmp,
              ...
              prediction=FALSE,
              sm="MD")
png("plots/SuppleFig7_8.png", width=700, height=300)
forest(m1, smlab="",xlim=c(-5,5),leftcols=c("studlab", "N cases"),
       rightcols=c("effect", "ci"),print.I2.ci = TRUE,print.tau2 = FALSE,
       leftlabs = c("Ancestry", "N cases"),rightlabs = c("Coefficients","95%CI"),zero.pval = TRUE)
dev.off()
